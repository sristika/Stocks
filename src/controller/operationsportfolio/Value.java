...
/**
 * Performs Value Operation on flexible portfolios.
 */
public class Value implements Operations {
   ...
   */
  public Value(InputStream in, PrintStream out, FlexiblePortfolioViewImpl view,
  ...
  public void executeOperation(String fileName) {
    try {
      ...
      String data = modal.valueOfPortfolio(fileName, stockObject, df.format(date));
