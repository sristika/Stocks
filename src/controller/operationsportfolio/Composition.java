...
/**
 * Performs Composition Operation on flexible portfolios.
 */
public class Composition implements Operations {
   ...
   */
  public Composition(InputStream in, PrintStream out, FlexiblePortfolioViewImpl view,
  ...
  public void executeOperation(String fileName) {
    ...
    try {
      ...
      String data = modal.compositionOfPortfolio(fileName, stockObject, df.format(date));
