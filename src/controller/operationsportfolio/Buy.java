...
/**
 * Performs Buy Operation on Flexible Portfolio.
 */
public class Buy implements Operations {
   ...
   */
  public Buy(InputStream in, PrintStream out, FlexiblePortfolioViewImpl view,
    ...
    try {
      ...
      if (commissionFee >= 0) {
        ...
        try {
          ...
          String data = df.format(date) + "," + "BUY" + "," + commissionFee + "," + tickerValues;
